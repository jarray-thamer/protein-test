...
const Footer = ({ information }) => {
  return (
    <footer className="mx-auto max-w-screen-2xl text-[#777777] mt-2 mb-4">
      <div className="py-8">
        <div className="container w-full px-4 mx-auto ">
          {/* subscribe */}
          <div className="mx-auto xl:w-1/2">
            <h1 className="font-bold uppercase text-black3">Abonnez-vous</h1>
            <p>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-[300px,1fr,1fr]">
            ...
            <div className="w-fit">
              ...
              <p className="mt-2 mb-4 text-sm">
                ...
                Équipement Sportif en Tunisie Experts depuis 2010 – Boostez vos
                performances avec des compléments certifiés (protéines ,
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Useful Links */}
                <div className="w-fit">
                  <h3 className="mb-3 font-bold text-[#333333]">
                    À propos de nous
                  </h3>
                ...
                {/* My Account */}
                <div className="w-fit">
                  <h3 className="mb-3 font-bold text-[#333333]">Aide</h3>
                  <ul className="space-y-2 text-sm">
                    <li>
                      <Link
                        className="transition-all duration-300 ease-in hover:text-primary"
          ...
          <div className="flex flex-col border-t border-t-[#cccccc]/50 items-center pt-6 mt-10 ">
            <p className="mb-4 text-sm text-center text-gray-600 uppercase sm:text-left sm:mb-0">
