  ...
  return (
    ...
    >
      <div className="flex flex-col items-center w-full p-4 pt-10 bg-white ">
        ...
        <div className="w-[90%] border-t-[0.5px]  border-black border-dashed my-8  " />
        ...
        <table className="w-full mt-6">
          <thead>
            <tr className="border-b-[0.5px] space-y-3 text-base  border-black border-dashed">
              <th className="py-3 text-left">Designation</th>
              <th className="pr-2 text-center">Qte</th>
          ...
          <tbody className="space-y-6">
            {data?.items.map((item, index) => (
              ...
              >
                <td className="py-4 text-left">{item?.designation}</td>
                <td className="pr-2 text-center">{item?.quantity}</td>
        ...
        {/* Conclusion  */}
        <div className="flex justify-between w-full mt-8 mb-1 text-base">
          <p>Total HT</p>
          <p>{data?.totalHT.toFixed(3)}</p>
        </div>
        <div className="flex justify-between w-full mt-0.5 mb-1 text-base">
          <p>Remise</p>
        ...
        {/* footer */}
        <p className="mt-14 mb-3 font-semibold underline decoration-[#FF4000]">
